---
{"dg-publish":true,"permalink":"/digital-garden/cv/","title":"Curriculum Vitae","dgShowBacklinks":"true","dgShowToc":"false","created":"2024-03-14","updated":"2025-10-12","dg-note-properties":{"title":"Curriculum Vitae","created":"2024-03-14","modified":"2025-10-12"}}
---
...
- Final project for Algebra's Front-end Developer course: https://github.com/dominoto/scaledrone-chat-app
- Final project for ZTM course from Udemy, front-end part: https://github.com/dominoto/smart-brain-hooks
- Final project for ZTM course from Udemy, back-end part: https://github.com/dominoto/smart-brain-api
- Project for ZTM course from Udemy: https://github.com/dominoto/robofriends-hooks
- Project in Python using openCV for image recognition: https://github.com/dominoto/opencv-test
...
- field implementation and commissioning of software in various countries around the world
- worked on projects for automotive, steel manufacturing and digital printing/embossing industries
- worked in various software environments (Siemens STEP7, WinCC, TIA Portal, Allen Bradley RSLogix, VMware)
- provided technical support and trained operators for clients
- balanced team and individual responsibilities effectively on a regular basis

## Education

**Partial qualification for Front-end Developer** | 10/2022 – 05/2023 | Rijeka, Croatia
**Algebra University College**
Modules: HTML, CSS, Javascript, Git, React

**Master of Electrical Engineering** | 2017 | Rijeka, Croatia
**University of Rijeka - Faculty of Engineering**
Specialization: Automation

## Skills

HTML | CSS | Javascript | React.JS | Git | Python | PLC and HMI programming
